 ...
 */
public class OAProfileResponse {

    public OAOpenSearchResponse openSearchProfileResponse;

    @Override
    public String toString() {
        return "Profiles{" + "openSearchProfileResponse=" + openSearchProfileResponse + '}';
    }
